...
Shader PersonModel::shader = Shader("./Shader/person/person.vs", "./Shader/person/person.fs");
...
TakeCubeModel PersonModel::takeCube1("土块.png");
TakeCubeModel PersonModel::takeCube2("沙子.png");
TakeCubeModel PersonModel::takeCube3("石头.png");
TakeCubeModel PersonModel::takeCube4("红砖.png");
TakeCubeModel PersonModel::takeCube5("木头.png");
TakeCubeModel PersonModel::takeCube6("基岩.png");
TakeCubeModel PersonModel::takeCube7("宝石.png");
TakeCubeModel PersonModel::takeCube8("石砖.png");
TakeCubeModel PersonModel::takeCube9("地砖.png");
...
unsigned int PersonModel::loadTexture(int rect, int i)
{
	...
	CImg<unsigned char> m_img = img.get_crop(personRect[rect][i][0], personRect[rect][i][1], personRect[rect][i][2], personRect[rect][i][3]);
    CImg<unsigned char> g_img = m_img.get_resize(m_img.width() * 10,m_img.height() * 10,1,3);
	
	//cv::resize(m_img, g_img, cv::Size(m_img.cols * 10, m_img.rows * 10), 0, 0, cv::INTER_NEAREST);

	glBindTexture(GL_TEXTURE_2D, textureID);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, g_img.width(), g_img.height(), 0, GL_RGB, GL_UNSIGNED_BYTE, g_img.data());
